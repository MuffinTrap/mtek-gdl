								  ...
								  u32 initFlags)
{
	...
	{
		static gdl::WiiController C;
		C.ZeroAllInputs();
		while(true)
		{
			ReadControllerInput(C);
			if (C.ButtonPress(gdl::WiiButtons::ButtonA))
			{
				break;
			}
			VIDEO_WaitVSync();
...
void gdl::PlatformWii::ReadControllerInput(gdl::WiiController& controllerInOut)
{
